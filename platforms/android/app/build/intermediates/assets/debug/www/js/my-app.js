...
//jjjj
        ...
        //  myApp.onPageBeforeAnimation('n1', function (page) {
          ...
          //  myApp.onPageBeforeAnimation('n1user', function (page) {
            $$(document).on('page:beforein', '.page[data-name="n1user"]', function (e) {
          ...
          $(".updateevent").click(function(){
              ...
              var myupdateform = myApp.form.convertToData('#edituserob');
                        ...
                        //return false;
                          ...
                          function kx2881t(result){
                                  ...
                                  if(result[0] == "ok"){
                                    myApp.dialog.alert('информация обновлена!','KAZPOISK');
                                  }
